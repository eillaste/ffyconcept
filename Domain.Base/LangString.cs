...
{
    public class LangString : LangString<Guid>, IDomainEntityId
    {
    ...
    public class LangString<TKey> : DomainEntityId<TKey>
        where TKey : IEquatable<TKey>
    {
        ...
        public static implicit operator string(LangString<TKey>? l) => l?.ToString() ?? "null";

        // LangString s = "Foo"
        public static implicit operator LangString<TKey>(string s) => new LangString<TKey>(s);
    }
}