...
namespace TestProject.IntegrationTests
{
    ...
    {
        private CustomWebApplicationFactory<WebApp.Startup> _factory;
        ...
        public async Task TestAuthAction_AuthFlow()
        {
            ...
            _testOutputHelper.WriteLine("wtf: " + redirectUri);
        ...
        public async Task Get_Register_Page(string uri)
        {
            ...
            {
                ["Input_Email"] = "customer100@customer100.customer100",
                ["Input_Password"] = "Customer100!",
                ["Input_ConfirmPassword"] = "Customer100!",
                ["Input_AccountType"] = "customer"
            };

            var regPostResponse = await _client.SendAsync(regForm, regFormValues);
            _testOutputHelper.WriteLine("regPostResponse: " + regPostResponse);
